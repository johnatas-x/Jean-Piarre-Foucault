 ...
 * @endcode
 */
$settings['hash_salt'] = '5Mxxx8MLnCfTizYWbA42oq7OaQfAI0JaKWMdi8fIuBROZQbkNXWSJmvDCA4q0vITP7WHnDd9uA';
...
// Cache Container on bootstrap (pure memcache) @see memcache/README.txt
...
$settings['memcache']['servers'] = json_decode(getenv('MEMCACHED_CONF'), TRUE);
...
$settings['memcache']['options'][Memcached::OPT_DISTRIBUTION] = Memcached::DISTRIBUTION_CONSISTENT;
$settings['memcache']['options'][Memcached::OPT_COMPRESSION] = FALSE;
$settings['memcache']['options'][Memcached::OPT_LIBKETAMA_COMPATIBLE] =TRUE;
 ...
 */
$settings['reverse_proxy'] = TRUE;
$settings['reverse_proxy_addresses'] = explode(',', getenv('REVERSE_PROXY_ADDRESSES'));
$settings['varnish_admin_port'] = getenv('VARNISH_ADMIN_PORT');
